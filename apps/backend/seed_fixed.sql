...
INSERT INTO "product_variants" (id, "productId", size, "colorName", "colorHex", sku, stock, "createdAt") VALUES
-- Tênis Urban Pro
('var-1', 'prod-1', '40', 'Preto', '#000000', 'TEN-URB-40-BLK', 50, NOW()),
('var-2', 'prod-1', '41', 'Preto', '#000000', 'TEN-URB-41-BLK', 45, NOW()),
('var-3', 'prod-1', '42', 'Preto', '#000000', 'TEN-URB-42-BLK', 40, NOW()),
('var-4', 'prod-1', '40', 'Branco', '#FFFFFF', 'TEN-URB-40-WHT', 30, NOW()),
('var-5', 'prod-1', '41', 'Branco', '#FFFFFF', 'TEN-URB-41-WHT', 35, NOW()),
-- Calça Cargo
('var-6', 'prod-2', 'P', 'Verde Militar', '#4A5D23', 'CAL-CAR-P-GRN', 25, NOW()),
('var-7', 'prod-2', 'M', 'Verde Militar', '#4A5D23', 'CAL-CAR-M-GRN', 30, NOW()),
('var-8', 'prod-2', 'G', 'Verde Militar', '#4A5D23', 'CAL-CAR-G-GRN', 28, NOW()),
('var-9', 'prod-2', 'P', 'Preto', '#000000', 'CAL-CAR-P-BLK', 20, NOW()),
-- Blusa Oversized
('var-10', 'prod-3', 'M', 'Cinza', '#808080', 'BLU-OVE-M-GRY', 40, NOW()),
('var-11', 'prod-3', 'G', 'Cinza', '#808080', 'BLU-OVE-G-GRY', 35, NOW()),
('var-12', 'prod-3', 'M', 'Preto', '#000000', 'BLU-OVE-M-BLK', 45, NOW())
ON CONFLICT (id) DO NOTHING;
