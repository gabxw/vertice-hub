...
INSERT INTO "product_images" (id, "productId", url, alt, "order", "createdAt", "updatedAt") VALUES
('img-1', 'prod-1', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff', 'Tênis Urban Pro', 1, NOW(), NOW()),
('img-2', 'prod-2', 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80', 'Calça Cargo Street', 1, NOW(), NOW()),
('img-3', 'prod-3', 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990', 'Blusa Oversized Essential', 1, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "product_benefits" (id, "productId", text, "order", "createdAt", "updatedAt") VALUES
('ben-1', 'prod-1', 'Solado antiderrapante de alta aderência', 1, NOW(), NOW()),
('ben-2', 'prod-1', 'Material respirável e confortável', 2, NOW(), NOW()),
('ben-3', 'prod-1', 'Design exclusivo VÉRTICE', 3, NOW(), NOW()),
('ben-4', 'prod-2', 'Múltiplos bolsos funcionais', 1, NOW(), NOW()),
('ben-5', 'prod-2', 'Tecido resistente e durável', 2, NOW(), NOW()),
('ben-6', 'prod-3', 'Caimento oversized moderno', 1, NOW(), NOW()),
('ben-7', 'prod-3', '100% algodão premium', 2, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Insert Product Tags
INSERT INTO "product_tags" (id, "productId", name, "createdAt", "updatedAt") VALUES
('tag-1', 'prod-1', 'Conforto', NOW(), NOW()),
('tag-2', 'prod-1', 'Estilo', NOW(), NOW()),
('tag-3', 'prod-1', 'Performance', NOW(), NOW()),
('tag-4', 'prod-2', 'Casual', NOW(), NOW()),
('tag-5', 'prod-2', 'Urbano', NOW(), NOW()),
('tag-6', 'prod-3', 'Essencial', NOW(), NOW()),
('tag-7', 'prod-3', 'Conforto', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Insert Coupons
INSERT INTO coupons (id, code, "discountType", "discountValue", "minPurchase", "maxDiscount", "usageLimit", "usedCount", "startDate", "endDate", "isActive", "createdAt", "updatedAt") VALUES
('coup-1', 'BEMVINDO10', 'PERCENTAGE', 10, 100, 50, 1000, 0, NOW(), NOW() + INTERVAL '30 days', true, NOW(), NOW()),
('coup-2', 'PRIMEIRACOMPRA', 'PERCENTAGE', 15, 150, 75, 500, 0, NOW(), NOW() + INTERVAL '60 days', true, NOW(), NOW()),
('coup-3', 'FRETEGRATIS', 'FIXED', 20, 200, 20, 2000, 0, NOW(), NOW() + INTERVAL '90 days', true, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
