...
-- Insert Product Images (no updatedAt)
...
-- Insert Product Variants (has updatedAt)
...
-- Insert Product Benefits (no updatedAt)
...
-- Insert Product Tags (no updatedAt)
